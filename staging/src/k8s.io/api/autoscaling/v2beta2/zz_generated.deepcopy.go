...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HPAScalingBehavior) DeepCopyInto(out *HPAScalingBehavior) {
	*out = *in
	...
	if in.ScaleUp != nil {
		...
		*out = new(HPAScalingDirectionBehavior)
		(*in).DeepCopyInto(*out)
	}
	if in.ScaleDown != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HPAScalingBehavior.
func (in *HPAScalingBehavior) DeepCopy() *HPAScalingBehavior {
	if in == nil {
		return nil
	}
	out := new(HPAScalingBehavior)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HPAScalingDirectionBehavior) DeepCopyInto(out *HPAScalingDirectionBehavior) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HPAScalingDirectionBehavior.
func (in *HPAScalingDirectionBehavior) DeepCopy() *HPAScalingDirectionBehavior {
	if in == nil {
		return nil
	}
	out := new(HPAScalingDirectionBehavior)
